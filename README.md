nohup sh shell/dsa_all_exp.sh &
nohup sh shell/grabmyo_all_exp.sh &
nohup sh shell/har_all_exp.sh &
nohup sh shell/uwave_all_exp.sh &
nohup sh shell/wisdm_all_exp.sh &
